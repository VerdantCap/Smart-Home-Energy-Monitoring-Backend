...
This unified service replaces the previous three-service architecture:

- `auth-service` → `/api/v1/auth/*`
- `ai-service` → `/api/v1/chat/*`
- `telemetry-service` → `/api/v1/telemetry/*`

All existing API endpoints remain compatible with the previous microservices.
